...
#include "ui_charts_ref.h"

Charts_Ref::Charts_Ref(QSqlDatabase &db, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Charts_Ref)
{
    ui->setupUi(this);
    ...
    vec_grapics_temper.at(GRAPH_REF::Ref1)->setPen(Pen);
    Pen.setColor(QColor(Qt::yellow));
    vec_grapics_temper.at(GRAPH_REF::Ref2)->setPen(Pen);
    Pen.setColor(QColor(Qt::green));
    vec_grapics_temper.at(GRAPH_REF::Ref3)->setPen(Pen);
    Pen.setColor(QColor(Qt::magenta));
    vec_grapics_temper.at(GRAPH_REF::Ref4)->setPen(Pen);
    Pen.setColor(QColor(Qt::red));
    vec_grapics_temper.at(GRAPH_REF::Ref5)->setPen(Pen);
    Pen.setColor(QColor(Qt::gray));
    vec_grapics_temper.at(GRAPH_REF::Ref6)->setPen(Pen);
//    Pen.setColor(QColor(Qt::cyan));
//    vec_grapics_temper.at(GRAPH_REF::Ref7)->setPen(Pen);

    Pen.setWidthF(2);                //ширина линии
    Pen.setColor(QColor(Qt::darkBlue));
    vec_grapics_hum.at(GRAPH_REF::Ref1)->setPen(Pen);
    Pen.setColor(QColor(Qt::darkYellow));
    vec_grapics_hum.at(GRAPH_REF::Ref2)->setPen(Pen);
    Pen.setColor(QColor(Qt::darkGreen));
    vec_grapics_hum.at(GRAPH_REF::Ref3)->setPen(Pen);
    Pen.setColor(QColor(Qt::darkMagenta));
    vec_grapics_hum.at(GRAPH_REF::Ref4)->setPen(Pen);
    Pen.setColor(QColor(Qt::darkRed));
    vec_grapics_hum.at(GRAPH_REF::Ref5)->setPen(Pen);
    Pen.setColor(QColor(Qt::darkGray));
    vec_grapics_hum.at(GRAPH_REF::Ref6)->setPen(Pen);
//    Pen.setColor(QColor(Qt::darkCyan));
//    vec_grapics_hum.at(GRAPH_REF::Ref7)->setPen(Pen);
...
//    vec_checkbox_tepl.push_back(ui->checkBoxTepl_7);
    ...
    connect(customPlot, &QCustomPlot::mouseDoubleClick, this, &Charts_Ref::slotMousePress);
...
void Charts_Ref::slotRangeChanged(const QCPRange &newRange)
{
...
void Charts_Ref::slotMousePress(QMouseEvent *event)
{
    ...
    for (int i = 0; i < vec_grapics_temper.size();  i++) {
        tracer->setGraph(customPlot->graph(i));   // Трассировщик будет работать с графиком i
        tracer->setGraphKey(coordX);
        tracer->updatePosition();
...
void Charts_Ref::on_checkBoxTepl1_stateChanged(int arg1)
{
    set_visible_graph(arg1, vec_grapics_temper.at(GRAPH_REF::Ref1), vec_grapics_hum.at(GRAPH_REF::Ref1));
    customPlot->replot(); // Перерисовываем содержимое полотна графика
}

void Charts_Ref::on_checkBoxTepl_2_stateChanged(int arg1)
{
    set_visible_graph(arg1, vec_grapics_temper.at(GRAPH_REF::Ref2), vec_grapics_hum.at(GRAPH_REF::Ref2));
    customPlot->replot(); // Перерисовываем содержимое полотна графика
}

void Charts_Ref::on_checkBoxTepl_3_stateChanged(int arg1)
{  
    set_visible_graph(arg1, vec_grapics_temper.at(GRAPH_REF::Ref3), vec_grapics_hum.at(GRAPH_REF::Ref3));
    customPlot->replot(); // Перерисовываем содержимое полотна графика
}

void Charts_Ref::on_checkBoxTepl_4_stateChanged(int arg1)
{
    set_visible_graph(arg1, vec_grapics_temper.at(GRAPH_REF::Ref4), vec_grapics_hum.at(GRAPH_REF::Ref4));
    customPlot->replot(); // Перерисовываем содержимое полотна графика
}

void Charts_Ref::on_checkBoxTepl_5_stateChanged(int arg1)
{
    set_visible_graph(arg1, vec_grapics_temper.at(GRAPH_REF::Ref5), vec_grapics_hum.at(GRAPH_REF::Ref5));
    customPlot->replot(); // Перерисовываем содержимое полотна графика
}

void Charts_Ref::on_checkBoxTepl_6_stateChanged(int arg1)
{
    set_visible_graph(arg1, vec_grapics_temper.at(GRAPH_REF::Ref6), vec_grapics_hum.at(GRAPH_REF::Ref6));
    customPlot->replot(); // Перерисовываем содержимое полотна графика
}

void Charts_Ref::on_checkBoxTepl_7_stateChanged(int arg1)
{
    set_visible_graph(arg1, vec_grapics_temper.at(GRAPH_REF::Ref7), vec_grapics_hum.at(GRAPH_REF::Ref7));
    customPlot->replot(); // Перерисовываем содержимое полотна графика
}
void Charts_Ref::on_checkBoxTepl_8_stateChanged(int arg1)
{
    set_visible_graph(arg1, vec_grapics_temper.at(GRAPH_REF::Ref8), vec_grapics_hum.at(GRAPH_REF::Ref8));
    customPlot->replot(); // Перерисовываем содержимое полотна графика
}


void Charts_Ref::on_checkBox_temper_stateChanged(int arg1)
{
    if(!arg1)
...
void Charts_Ref::set_visible_graph(bool st, QCPGraph *graph_t, QCPGraph *graph_h)
{
...
void Charts_Ref::on_pushButton_clicked()
{
    ...
    QString sel = "SELECT DateTime, Холодильник_1t, Холодильник_2t, Холодильник_3t, Холодильник_4t, Холодильник_5t, Холодильник_6t, Холодильник_1h, Холодильник_2h, Холодильник_3h, Холодильник_4h, Холодильник_5h, Холодильник_6h FROM Ref WHERE DateTime BETWEEN '" + begin_ + "' and '" + end_ + "'";
    query.exec(sel);

    QVector <QVector<double>> data(15);
    ...
    vec_grapics_temper.at(GRAPH_REF::Ref1)->setData(data.at(0), data.at(1));
    vec_grapics_temper.at(GRAPH_REF::Ref2)->setData(data.at(0), data.at(2));
    vec_grapics_temper.at(GRAPH_REF::Ref3)->setData(data.at(0), data.at(3));
    vec_grapics_temper.at(GRAPH_REF::Ref4)->setData(data.at(0), data.at(4));
    vec_grapics_temper.at(GRAPH_REF::Ref5)->setData(data.at(0), data.at(5));
    vec_grapics_temper.at(GRAPH_REF::Ref6)->setData(data.at(0), data.at(6));
//    vec_grapics_temper.at(GRAPH_REF::Ref7)->setData(data.at(0), data.at(7));

     vec_grapics_hum.at(GRAPH_REF::Ref1)->setData(data.at(0), data.at(7));   // Устанавливаем данные
     vec_grapics_hum.at(GRAPH_REF::Ref2)->setData(data.at(0), data.at(8)); // Устанавливаем данные
     vec_grapics_hum.at(GRAPH_REF::Ref3)->setData(data.at(0), data.at(9)); // Устанавливаем данные
     vec_grapics_hum.at(GRAPH_REF::Ref4)->setData(data.at(0), data.at(10)); // Устанавливаем данные
     vec_grapics_hum.at(GRAPH_REF::Ref5)->setData(data.at(0), data.at(11)); // Устанавливаем данные
     vec_grapics_hum.at(GRAPH_REF::Ref6)->setData(data.at(0), data.at(12)); // Устанавливаем данные

    on_pushButtonAutoScale_clicked();
}

void Charts_Ref::on_checkBox_hum_stateChanged(int arg1)
{
    if(!arg1)
...
void Charts_Ref::on_pushButtonAutoScale_clicked()
{
...
void Charts_Ref::keyReleaseEvent(QKeyEvent *event)
{
...
void Charts_Ref::keyPressEvent(QKeyEvent *event)
{
    if (event->key() == Qt::Key_Control){
