#ifndef CHARTS_SCLAD_H
#define CHARTS_SCLAD_H
...
class Charts_Sclad : public QDialog
{
  Q_OBJECT

public:
  explicit Charts_Sclad(QSqlDatabase &db, QWidget *parent = nullptr);
  ~Charts_Sclad();
...
private slots:
  ...
  void on_checkBox_air_stateChanged(int arg1);
...
private:
  ...
  const int NUMBER_ACTIV_SCLAD = 1;
  ...
  QVector <QCPGraph*> vec_grapics_light{};
  QVector <QCPGraph*> vec_grapics_air{};

  QVector <QCheckBox*> vec_checkbox_tepl{};
  void set_visible_graph(bool st, QCPGraph *graph_t, QCPGraph *graph_h);
  void on_off_graph(int arg,  QVector <QCPGraph*> &graph);

  virtual void keyReleaseEvent(QKeyEvent *event);
  virtual void keyPressEvent(QKeyEvent *event);
};

#endif // CHARTS_SCLAD_H
